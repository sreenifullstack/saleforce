  ...
  <div className="my-2">
    ...
    <div className="w-full"> 
      ...
      <div className="float-right inline-block">
        ...
        <Button className=" mr-2 text-gray-400  font-medium inline-flex justify-center place-items-center">
          Show 
        </Button>

        <Button className=" bg-indigo-800 text-white font-medium inline-flex justify-center place-items-center">
          Hide 
        </Button>
    ...
    <div className="mt-4">
      <div className="text-right mb-2"><SearchBar/></div>
